...
const resize = (source, key) => {
    ...
    const promiseCallback = (resolve, reject) => {
        ...
        sharp(source)
            .resize(IMAGE_SIZE_HALF, IMAGE_SIZE_HALF, fillOptions) // if you do not want to fill up your images with colors just remove the "fillOptions" command
            .toBuffer((error, data) => {
...
const generate = (linkedin, facebook, instagram, tinder) => {
    ...
    const outputOptions = {
        path: OUTPUT_PATH,
        name: `dollypartonchallenge-${uuidv4()}.jpg`
    };
...
// generate("./images/facebook.JPG");

// resize('./images/facebook.jpg', './images/result1.jpg');

generate("./images/facebook.jpg", "./images/facebook.jpg", "./images/facebook.jpg", "./images/facebook.jpg")
    .then(console.log)
    .catch(console.error);
